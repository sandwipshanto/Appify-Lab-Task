          ...
          <div className="_feed_top_fixed">
            <div className="_feed_right_inner_area_card_content _mar_b24">
              ...
              <span className="_feed_right_inner_area_card_content_txt">
                <span className="_feed_right_inner_area_card_content_txt_link">See All</span>
              </span>
            </div>
            <form className="_feed_right_inner_area_card_form" action="#">
              ...
              <input className="form-control me-2 _feed_right_inner_area_card_form_inpt" type="search" placeholder="input search text" aria-label="Search" disabled />
            </form>
          </div>
